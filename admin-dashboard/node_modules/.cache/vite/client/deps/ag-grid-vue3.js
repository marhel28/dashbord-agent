import {
  ...
  _warn,
  createGrid
} from "./chunk-LW3FHKU3.js";
import "./chunk-HKJ2B2AA.js";

// node_modules/ag-grid-vue3/dist/main.mjs
import { defineComponent as z, createVNode as K, render as A, isRef as M, isReactive as H, isProxy as k, toRaw as E, mergeModels as G, useTemplateRef as Q, shallowRef as m, toRefs as Y, watch as I, useModel as J, getCurrentInstance as F, onMounted as X, markRaw as Z, onUnmounted as ee, createElementBlock as oe, openBlock as te, mergeDefaults as ne } from "vue";
var q = Object.defineProperty;
var $ = (s, t, o) => t in s ? q(s, t, { enumerable: true, configurable: true, writable: true, value: o }) : s[t] = o;
var y = (s, t, o) => $(s, typeof t != "symbol" ? t + "" : t, o);
var D = class D2 {
  static getComponentDefinition(t, o) {
    let e;
    return typeof t == "string" ? e = this.searchForComponentInstance(o, t) : e = { extends: z({ ...t }) }, e || _error(114, { component: t }), e.extends ? (e.extends.setup && (e.setup = e.extends.setup), e.extends.props = this.addParamsToProps(e.extends.props)) : e.props = this.addParamsToProps(e.props), e;
  }
  ...
  static createAndMountComponent(t, o, e, p) {
    const r = D2.getComponentDefinition(t, e);
    if (!r)
      return;
    const { vNode: a, destroy: i, el: n } = this.mount(
      r,
  ...
  static mount(t, o, e, p) {
    let r = K(t, o);
    r.appContext = { ...e.appContext, provides: p };
    let a = document.createDocumentFragment();
    return A(r, a), { vNode: r, destroy: () => {
      a && A(null, a), a = null, r = null;
    }, el: a };
  }
  static searchForComponentInstance(t, o, e = 10, p = false) {
    let r = this.componentCache.get(t);
    if (r) {
      const l = r.get(o);
      if (l !== void 0)
        return l;
    }
    let a = null, i = 0, n = t.parent;
    for (; !a && n && n.components && ++i < e; )
      n.components && n.components[o] && (a = n.components[o]), n = n.parent;
    for (i = 0, n = t.parent; !a && n && n.$options && ++i < e; ) {
      const l = n;
      l.$options && l.$options.components && l.$options.components[o] ? a = l.$options.components[o] : l[o] && (a = l[o]), n = n.parent;
    }
    for (i = 0, n = t.parent; !a && n && ++i < e; ) {
      if (n.exposed) {
        const l = n;
        l.exposed && l.exposed[o] ? a = l.exposed[o] : l[o] && (a = l[o]);
      }
      n = n.parent;
    }
    if (!a) {
    ...
    return !a && !p ? (_error(114, { component: o }), null) : (a && (r || (r = /* @__PURE__ */ new Map(), this.componentCache.set(t, r)), r.set(o, a)), a);
  }
};
y(D, "componentCache", /* @__PURE__ */ new WeakMap());
var f = D;
var ye = class extends BaseComponentWrapper {
  constructor(o, e) {
    super();
    y(this, "parent");
    y(this, "provides");
    this.parent = o, this.provides = e;
  }
  createWrapper(o) {
    const e = this;
    class p extends Ce {
      ...
      hasMethod(i) {
        var l, c;
        const n = r.getFrameworkComponentInstance();
        return n[i] ? true : ((l = n.$.exposed) == null ? void 0 : l[i]) != null || ((c = n.exposed) == null ? void 0 : c[i]) != null || n.$.setupState[i] != null;
      }
      callMethod(i, n) {
        var R, S;
        const l = this.getFrameworkComponentInstance(), c = r.getFrameworkComponentInstance();
        if (c[i])
          return c[i].apply(l, n);
        {
          const C = ((R = l.$.exposed) == null ? void 0 : R[i]) || ((S = l.exposed) == null ? void 0 : S[i]) || l.$.setupState[i];
          return C == null ? void 0 : C.apply(l, n);
        }
      }
      addMethod(i, n) {
        r[i] = n;
      ...
      processMethod(i, n) {
        return i === "refresh" && (this.getFrameworkComponentInstance().params = Object.freeze(n[0])), this.hasMethod(i) ? this.callMethod(i, n) : i === "refresh";
      }
      createComponent(i) {
        return e.createComponent(o, i);
      }
    }
    const r = new p();
    return r;
  ...
  createComponent(o, e) {
    return f.createAndMountComponent(o, e, this.parent, this.provides);
  }
  createMethodProxy(o, e, p) {
    return function() {
      return o.hasMethod(e) ? o.callMethod(e, arguments) : (p && _warn(233, { methodName: e }), null);
    };
  }
  destroy() {
    this.parent = null;
...
var Ce = class {
  ...
  destroy() {
    var t;
    this.getFrameworkComponentInstance() && typeof this.getFrameworkComponentInstance().destroy == "function" && this.getFrameworkComponentInstance().destroy(), (t = this.unmount) == null || t.call(this);
  }
  getFrameworkComponentInstance() {
    return this.componentInstance;
  }
  init(t) {
    const { componentInstance: o, element: e, destroy: p } = this.createComponent(t);
    this.componentInstance = o, this.unmount = p, this.element = e.firstElementChild ?? e;
  }
};
var me = class extends VanillaFrameworkOverrides {
  constructor(o) {
    super("vue");
    y(this, "parent");
    this.parent = o;
   ...
   */
  frameworkComponent(o, e) {
    let p = f.searchForComponentInstance(this.parent, o, 10, true) ? o : null;
    if (!p && e && e[o]) {
      const r = e[o];
      p = f.searchForComponentInstance(this.parent, r, 10, true) ? r : null;
    }
    return p;
  }
  isFrameworkComponent(o) {
...
var we = (s, t) => {
  let o;
  const e = () => {
    window.clearTimeout(o), o = window.setTimeout(s, t);
  };
  return e.cancel = () => {
...
function w(s) {
  if (s == null || typeof s != "object")
    return s;
  const t = /* @__PURE__ */ new WeakSet(), o = (e) => {
    ...
    if (Array.isArray(e)) {
      ...
      return a ? e.map((i) => o(i)) : e;
    }
    if (t.has(e))
      return e;
    t.add(e);
    const p = Object.keys(e), r = {};
...
var De = z({
  ...
  emits: G(["update:modelValue"], ["update:modelValue"]),
  setup(s, { expose: t, emit: o }) {
    const e = s, p = Q("root"), r = m(void 0), a = m(false), i = m(false), n = m(false);
    let l = {}, c = false;
    const R = Y(e), S = new Set(_GET_SHALLOW_GRID_OPTIONS());
    _GET_ALL_GRID_OPTIONS().filter((d) => d != "gridOptions").forEach((d) => {
      const u = R[d];
      u && I(
        u,
        (v, g) => {
          (d === "rowData" && !h.value || d !== "rowData") && x(d, v), d === "rowData" && (h.value = false);
        },
        S.has(d) ? void 0 : { deep: true }
      );
    });
    const C = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), P = J(s, "modelValue"), B = m(false), h = m(false), W = o;
    I(
      P,
      (d, u) => {
        a.value && (h.value || (B.value = true, x("rowData", w(d), w(u))), h.value = false);
      },
      { deep: true }
    );
    const T = we(() => {
      h.value = true, W("update:modelValue", U());
    }, 10), b = F(), N = (d) => {
      var u, v;
      n.value && C.has(d) && (v = (u = b == null ? void 0 : b.vnode) == null ? void 0 : u.props) != null && v["onUpdate:modelValue"] && T();
    }, _ = () => P.value || e.rowData || e.gridOptions.rowData, U = () => {
      const d = [];
      return r == null || r.value.forEachLeafNode((u) => {
        d.push(u.data);
      }), d;
    }, O = (d) => (u) => {
      if (i.value)
        return;
      u === "gridReady" && (n.value = true);
      const v = ALWAYS_SYNC_GLOBAL_EVENTS.has(u);
      v && !d || !v && d || C.has(u) && (!B.value && a.value && N(u), B.value = false);
    }, x = (d, u, v) => {
      if (a.value) {
        let g = u;
        d === "rowData" && g != null && (g = w(g)), l[d] = g, c || (c = true, queueMicrotask(() => {
          c = false, !i.value && r.value && _processOnChange(l, r.value), l = {};
        }));
      }
    }, j = () => Object.create(F().provides);
    return X(() => {
      _registerModule(RowApiModule, void 0);
      const d = new ye(F(), j()), u = {
        globalListener: O(),
        globalSyncListener: O(true),
        frameworkOverrides: new me(F()),
        providedBeanInstances: {
          frameworkCompWrapper: d
        },
        modules: e.modules
      }, v = Z(
        _combineAttributesAndGridOptions(w(e.gridOptions), e, [
          ..._GET_ALL_GRID_OPTIONS(),
      ...
      g !== void 0 && (B.value = true, v.rowData = w(g)), r.value = createGrid(p.value, v, u), a.value = true;
    }), ee(() => {
      var d;
      a.value && (T.cancel(), (d = r == null ? void 0 : r.value) == null || d.destroy(), i.value = true);
    }), t({
      api: r
    }), (d, u) => (te(), oe("div", Re, null, 512));
  }
});
export {
  De as AgGridVue
