import type { AlignedGrid, AlwaysPassFilter, AutoGenerateColumnDefsOptions, AutoGroupColumnDef, AutoSizeStrategy, CalculatedColumnsGridOption, CellSelectionOptions, ChartToolPanelsDef, ColDef, ColGroupDef, ColTypeDefs, Components, CreateChartContainer, CsvExportParams, CustomChartThemes, DataTypeDefinitions, DefaultChartMenuItem, DoesExternalFilterPass, DomLayoutType, EditStrategyType, EditValidationCommitType, ExcelExportParams, ExcelStyle, FillOperation, FilterHandlers, FindOptions, FocusGridInnerElement, FormulaDataSource, FormulaFuncs, FullWidthNotesDataSource, GetBusinessKeyForNode, GetChartMenuItems, GetChartToolbarItems, GetChildCount, GetContextMenuItems, GetDataPath, GetDocument, GetFullRowEditValidationErrors, GetGroupRowAgg, GetLocaleText, GetMainMenuItems, GetRowClass, GetRowHeight, GetRowIdFunc, GetRowStyle, GetServerSideGroupKey, GetServerSideGroupLevelParams, GridState, GroupHierarchyConfig, IAdvancedFilterBuilderParams, IAdvancedFilterParams, IAggFuncs, IDatasource, IServerSideDatasource, IViewportDatasource, Icons, InitialGroupOrderComparator, IsApplyServerSideTransaction, IsExternalFilterPresent, IsFullWidthRow, IsGroupOpenByDefault, IsRowFilterable, IsRowMaster, IsRowPinnable, IsRowPinned, IsRowSelectable, IsRowValidDropPositionCallback, IsServerSideGroup, IsServerSideGroupOpenByDefault, LoadingCellRendererSelectorFunc, LocaleText, MenuItemDef, NavigateToNextCell, NavigateToNextHeader, NotesDataSource, OverlaySelectorFunc, OverlayType, PaginationNumberFormatter, PaginationPanel, PivotColumnGroupTotals, PivotRowTotals, PostProcessPopup, PostSortRows, ProcessAutoGeneratedColumnDefs, ProcessCellForClipboard, ProcessCellFromClipboard, ProcessDataFromClipboard, ProcessFileInputParams, ProcessGroupHeaderForClipboard, ProcessHeaderForClipboard, ProcessPivotResultColDef, ProcessPivotResultColGroupDef, ProcessRowPostCreate, ProcessUnpinnedColumns, QuickFilterMatcher, QuickFilterParser, RowClassRules, RowDragTextFunc, RowGroupingDisplayType, RowModelType, RowNumbersOptions, RowSelectionOptions, RowStyle, SelectionColumnDef, SendToClipboard, SideBarDef, SortDirection, StatusBar, TabToNextCell, TabToNextGridContainer, TabToNextHeader, Theme, Toolbar, TreeDataDisplayType, UseGroupTotalRow } from 'ag-grid-community';
...
export declare function getProps(): {
    ...
    autoGenerateColumnDefs: undefined;
    processAutoGeneratedColumnDefs: undefined;
...
export declare const debounce: (func: () => void, delay: number) => {
    (): void;
    cancel(): void;
};
