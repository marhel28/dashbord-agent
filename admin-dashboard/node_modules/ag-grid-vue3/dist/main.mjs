...
var $ = (s, t, o) => t in s ? q(s, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : s[t] = o;
...
import { _error as V, BaseComponentWrapper as ie, _warn as ae, VanillaFrameworkOverrides as re, _GET_SHALLOW_GRID_OPTIONS as le, _GET_ALL_GRID_OPTIONS as L, _processOnChange as de, _registerModule as se, RowApiModule as pe, _combineAttributesAndGridOptions as ue, _PUBLIC_EVENT_HANDLERS_MAP as ve, createGrid as ce, ALWAYS_SYNC_GLOBAL_EVENTS as ge } from "ag-grid-community";
const D = class D {
  static getComponentDefinition(t, o) {
    let e;
    return typeof t == "string" ? e = this.searchForComponentInstance(o, t) : e = { extends: z({ ...t }) }, e || V(114, { component: t }), e.extends ? (e.extends.setup && (e.setup = e.extends.setup), e.extends.props = this.addParamsToProps(e.extends.props)) : e.props = this.addParamsToProps(e.props), e;
  }
  ...
  static createAndMountComponent(t, o, e, p) {
    const r = D.getComponentDefinition(t, e);
    if (!r)
      return;
  ...
  static searchForComponentInstance(t, o, e = 10, p = !1) {
    ...
    return !a && !p ? (V(114, { component: o }), null) : (a && (r || (r = /* @__PURE__ */ new Map(), this.componentCache.set(t, r)), r.set(o, a)), a);
  }
};
...
class ye extends ie {
  ...
  createWrapper(o) {
    ...
    class p extends Ce {
      ...
      hasMethod(i) {
        ...
        return n[i] ? !0 : ((l = n.$.exposed) == null ? void 0 : l[i]) != null || ((c = n.exposed) == null ? void 0 : c[i]) != null || n.$.setupState[i] != null;
      }
      callMethod(i, n) {
        var R, S;
  ...
  createMethodProxy(o, e, p) {
    return function() {
      return o.hasMethod(e) ? o.callMethod(e, arguments) : (p && ae(233, { methodName: e }), null);
    };
  }
  destroy() {
    this.parent = null;
...
class me extends re {
  ...
  frameworkComponent(o, e) {
    let p = f.searchForComponentInstance(this.parent, o, 10, !0) ? o : null;
    if (!p && e && e[o]) {
      const r = e[o];
      p = f.searchForComponentInstance(this.parent, r, 10, !0) ? r : null;
    }
    return p;
  }
...
const Re = { ref: "root" }, De = /* @__PURE__ */ z({
  __name: "AgGridVue",
  props: /* @__PURE__ */ G(/* @__PURE__ */ ne({
    gridOptions: {},
    modules: {},
    toolbar: {},
    statusBar: {},
  ...
  setup(s, { expose: t, emit: o }) {
    const e = s, p = Q("root"), r = m(void 0), a = m(!1), i = m(!1), n = m(!1);
    let l = {}, c = !1;
    const R = Y(e), S = new Set(le());
    L().filter((d) => d != "gridOptions").forEach((d) => {
      const u = R[d];
      u && I(
        u,
        (v, g) => {
          (d === "rowData" && !h.value || d !== "rowData") && x(d, v), d === "rowData" && (h.value = !1);
        },
        S.has(d) ? void 0 : { deep: !0 }
      );
    });
    const C = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), P = J(s, "modelValue"), B = m(!1), h = m(!1), W = o;
    I(
      P,
      (d, u) => {
        a.value && (h.value || (B.value = !0, x("rowData", w(d), w(u))), h.value = !1);
      },
      { deep: !0 }
    );
    const T = we(() => {
      h.value = !0, W("update:modelValue", U());
    }, 10), b = F(), N = (d) => {
      var u, v;
      ...
      if (i.value)
        return;
      u === "gridReady" && (n.value = !0);
      const v = ge.has(u);
      v && !d || !v && d || C.has(u) && (!B.value && a.value && N(u), B.value = !1);
    }, x = (d, u, v) => {
      if (a.value) {
        let g = u;
        d === "rowData" && g != null && (g = w(g)), l[d] = g, c || (c = !0, queueMicrotask(() => {
          c = !1, !i.value && r.value && de(l, r.value), l = {};
        }));
      }
    ...
    return X(() => {
      ...
      g !== void 0 && (B.value = !0, v.rowData = w(g)), r.value = ce(p.value, v, u), a.value = !0;
    }), ee(() => {
      var d;
      a.value && (T.cancel(), (d = r == null ? void 0 : r.value) == null || d.destroy(), i.value = !0);
    }), t({
      api: r
