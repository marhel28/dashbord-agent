...
const styles = {
  ...
  "layouts/default.vue": () => import('./default-styles.Bg-2tzKY.mjs').then(interopDefault),
  "components/MerchantLocationEdit.vue": () => import('./_uuid_-styles.l8r1J4t7.mjs').then(interopDefault)
};
