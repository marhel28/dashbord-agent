  ...
  setup(__props) {
    ...
    const colDefs = ref([
      ...
      },
      {
        ...
        cellRenderer: (p) => {
          var _a;
          const isVerified = p.value === true || ((_a = p.data) == null ? void 0 : _a.is_verified) === true;
          if (isVerified) {
            return `<div style="display: flex; align-items: center; height: 100%;">
...
//# sourceMappingURL=index-DxHhQmr7.mjs.map
