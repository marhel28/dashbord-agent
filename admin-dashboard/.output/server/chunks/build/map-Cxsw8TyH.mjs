  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (hoveredCluster.value) {
        ...
        _push(` ${ssrInterpolate(hoveredMerchant.value.address || "Alamat belum diatur dalam database.")}</p></div><div class="bg-slate-50/80 p-3 rounded-xl border border-slate-100"><p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider mb-1">Koordinat Presisi</p><p class="font-mono text-[11px] text-blue-700 font-bold bg-blue-50 p-2 rounded-lg text-center border border-blue-100">${ssrInterpolate((_a = hoveredMerchant.value.latitude) == null ? void 0 : _a.toFixed(5))}, ${ssrInterpolate((_b = hoveredMerchant.value.longitude) == null ? void 0 : _b.toFixed(5))}</p></div></div></div>`);
      } else {
...
//# sourceMappingURL=map-Cxsw8TyH.mjs.map
