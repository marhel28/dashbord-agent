...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { KpiSummary, TrendPoint, CategorySlice, PaymentSlice, TopProduct, RecentSale, AnalyticsData } from '../../composables/useAnalytics'
  import('../../composables/useAnalytics')
  // @ts-ignore
  export type { User, RegisterPayload, LoginResponse } from '../../composables/useAuth'
