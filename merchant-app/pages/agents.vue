...
const fallbackAgents: AgentDef[] = [
  ...
  { id: 'marketing', name: 'Marketing Agent', icon: 'heroicons:megaphone', description: 'Strategi pemasaran, copywriting, ide promosi & bundling.', capabilities: ['Ide promo & bundling', 'Copywriting teks promosi', 'Fast/slow moving analysis', 'Strategi pelanggan'], color: '#8B5CF6', bg: 'rgba(139,92,246,0.06)' },
